package com.svanty.library.slugify;
...
public class Slugify {
	private static final String BUILTIN_REPLACEMENTS_FILENAME = "library/slugify.properties";
...
//		String text = Transliterator.getInstance(ASCII).transliterate(input);
		String text = matchAndReplace(input);
		return text;
	}
